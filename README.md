...
🌐 **[gamectl.cc](https://gamectl.cc)** &nbsp;·&nbsp; 🚀 **Public beta — `v0.0.35-beta`** &nbsp;·&nbsp; 🔗 **Sibling: [ProxyCTL](https://proxyctl.cc)** — host your servers on the internet, securely
...
> at `v0.0.35-beta`. It's stable enough for day-to-day self-hosting and
...
**14 games deployable today — every one of them on GameCTL's own
...
2 is the first**, and the same pattern is how remaining Windows-only titles
(CarX and friends) will land.*
...
- More first-party game images (Windows-only servers under Wine, following Wreckfest 2)
...
official SteamCMD. Windows-only servers (currently Wreckfest 2) run under
WineHQ's official builds. Any image can still be overridden in the wizard if
...
**Public beta `v0.0.35-beta`** · Active development · Interfaces, templates, and structure subject to change
