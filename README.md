...
🌐 **[gamectl.cc](https://gamectl.cc)** &nbsp;·&nbsp; 🚀 **Public beta — `v0.0.43-beta`** &nbsp;·&nbsp; 🔗 **Sibling: [ProxyCTL](https://proxyctl.cc)** — host your servers on the internet, securely
...
> at `v0.0.43-beta`. It's stable enough for day-to-day self-hosting and
...
**Public beta `v0.0.43-beta`** · Active development · Interfaces, templates, and structure subject to change
