...
🌐 **[gamectl.cc](https://gamectl.cc)** &nbsp;·&nbsp; 🚀 **Public beta — `v0.0.46-beta`** &nbsp;·&nbsp; 🔗 **Sibling: [ProxyCTL](https://proxyctl.cc)** — host your servers on the internet, securely
...
> at `v0.0.46-beta`. It's stable enough for day-to-day self-hosting and
...
**24 games deployable today — every one of them on GameCTL's own
...
| Palworld | `palworld-kube` | ✅ Supported |
| IW4x (Call of Duty: MW2) *(bring your own game files)* | `iw4x-kube` | ✅ Supported |
| DayZ | — | 🔜 Upcoming *(needs a first-party image + your own Steam account)* |
...
**Public beta `v0.0.46-beta`** · Active development · Interfaces, templates, and structure subject to change
