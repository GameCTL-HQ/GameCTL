...
🌐 **[gamectl.cc](https://gamectl.cc)** &nbsp;·&nbsp; 🚀 **Public beta — `v0.0.22-beta`**
...
> at `v0.0.22-beta`. It's stable enough for day-to-day self-hosting and
...
**Public beta `v0.0.22-beta`** · Active development · Interfaces, templates, and structure subject to change
