  ...
  return (
    <>
      <div ref={wrapperRef} className="relative">
        ...
        {open && (
          <div className="absolute left-0 right-0 sm:left-auto sm:right-0 mt-2 w-auto sm:w-96 max-h-[60vh] overflow-y-auto rounded-xl border border-slate-700 bg-slate-900 shadow-2xl z-40">
