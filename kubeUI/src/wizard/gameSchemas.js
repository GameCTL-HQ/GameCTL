...
const egressPublishField = (what = 'the public server list') => ({
  ...
  hint: 'ON — listed in ' + what + ', joinable from it. Costs steady droplet '
    + 'bandwidth: everyone browsing the list queries your server, and public query ports '
    + 'get scanned constantly.\n'
    + 'OFF — not listed anywhere, no query traffic. Players join by address.',
})
