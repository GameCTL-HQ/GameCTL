...
// separate from the per-instance "Advertise publicly" toggle in
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <p className="text-sm text-slate-400 mb-5">
        ...
        that lists only the instances you've flagged <span className="text-slate-300">Advertise publicly</span> on
        ...
        <div className="rounded-lg border border-slate-800 bg-slate-900/40 p-4 space-y-3">
          ...
          {status?.enabled && status?.token && (
            <div className="space-y-2">
              ...
              <div>
                <p className="text-[11px] text-slate-500 mb-1">Bearer token — treat like a password; anyone with it can read your advertised server list</p>
                <div className="flex items-center gap-2">
      ...
      <p className="text-sm text-slate-400 mb-4">
        ...
        reads this Stats API and lists your advertised servers. Independent of the Stats API toggle above — deploying it needs a token
