...
export default function MonitoringSettings() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
      ...
      {/* Always present, working or not, and at the TOP: the whole reason
          someone opens Monitoring is to look at CPU/RAM, so the command that
          makes those work belongs where they land — not buried under the
          panels that are empty precisely because it hasn't been run. */}
