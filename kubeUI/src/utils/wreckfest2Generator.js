...
export const defaultWreckfest2Form = {
  ...
  // default: Wreckfest 2's browser is PlayFab, which records the address the
  // server registered FROM. Without this PlayFab stores the cluster's WAN
  // while the public port lives on the droplet, so the lobby is listed but
  // unjoinable.
  //
