...
export function buildCs2Yaml(f = defaultCs2Form) {
  ...
  const surfCfg = isSurf ? [
    ...
    'mp_friendlyfire 0',
    // Surf is a movement game — players spawn with a knife only, no
    // buy menu, no money. Empty default loadouts strip the pistol;
    // instant respawn so a missed ramp doesn't bench you for a round.
