...
function parseHash() {
  ...
  if (section === 'steam')     return { view: 'steam',     selectedGame: null }
      ...
      <header className="border-b border-slate-800 bg-slate-900 sticky top-0 z-20">
        <div className="max-w-[92rem] mx-auto px-4 py-3 flex items-center gap-3 sm:gap-4">
          ...
          <div className="hidden sm:flex ml-auto items-center gap-2">
            ...
            <button
              onClick={() => { setView('steam'); setSelectedGame(null) }}
              className={`px-3 py-1.5 rounded-lg text-sm border ${view === 'steam' ? 'bg-slate-800 border-slate-600' : 'border-transparent hover:bg-slate-800'}`}
            >
              Steam
            </button>
            <button
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden border-t border-slate-800 px-4 py-3 flex flex-col gap-3">
            ...
            <button
              onClick={() => { setView('steam'); setSelectedGame(null) }}
              className={`w-full text-left px-3 py-2 rounded-lg text-sm border ${view === 'steam' ? 'bg-slate-800 border-slate-600' : 'border-slate-800 hover:bg-slate-800'}`}
            >
              Steam
            </button>
            <button
